$(function(){
	...
	if($(".newqkdown2").length > 0){
		...
		downititle2 = downititle2.replace(',', '');
		var donwiurl = 'http://id.hndazhan.com/az/'+encodeURI(downititle2)+'_id371@371_'+downitype+downiaid;
		$(".newqkdown2").attr('href', donwiurl);
		if($(".newqkdown3").length>0){
			donwiurl = 'http://id.hndazhan.com/az/'+encodeURI(downititle2)+'_id372@372_'+downitype+downiaid;
